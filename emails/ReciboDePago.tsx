...
// ----------------------------------------------------
export const ReciboDePago = ({ nombreUsuario, monto, fecha, idTransaccion }: ReciboDePagoProps) => (
  <Html>
    <Head />
    ...
    <Tailwind>
      <Body className="bg-gray-100 my-auto mx-auto font-sans">
        <Container className="bg-white border border-solid border-[#eaeaea] rounded my-10 mx-auto p-8 w-[600px] shadow-lg">
          ...
          <Text className="text-gray-700 text-base leading-6">
            ¡Tu pago se ha procesado con éxito! Aquí tienes el detalle completo de la transacción.
          </Text>
          ...
          <Section className="mb-6">
            <Row>
              <Column className="w-1/2">
                <Text className="text-gray-500 text-sm font-semibold m-0">Fecha de Transacción:</Text>
              </Column>
              <Column className="w-1/2">
                <Text className="text-black text-base font-medium m-0 text-right">{fecha}</Text>
              </Column>
            </Row>
            <Row className="mt-2">
              <Column className="w-1/2">
                <Text className="text-gray-500 text-sm font-semibold m-0">ID de Transacción:</Text>
              </Column>
              <Column className="w-1/2">
                <Text className="text-black text-base font-medium m-0 text-right">{idTransaccion}</Text>
              </Column>
            </Row>
          </Section>
          ...
          <Section className="bg-green-50 p-4 rounded-md">
            <Row>
              <Column className="w-1/2">
                <Text className="text-lg font-bold text-green-700 m-0">TOTAL PAGADO:</Text>
              </Column>
              <Column className="w-1/2">
                <Text className="text-2xl font-extrabold text-green-700 m-0 text-right">${monto.toFixed(2)}</Text>
              </Column>
            </Row>
          </Section>
